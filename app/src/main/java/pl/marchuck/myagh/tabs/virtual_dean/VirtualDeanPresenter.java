 ...
 * @since 11.05.16.
 */
public class VirtualDeanPresenter {
    public static final String TAG = VirtualDeanPresenter.class.getSimpleName();
    ...
    public void login() {
        ...
        if (validatedFields(usernameLayout, editTextLogin, "Login")
    ...
    interface VirtualDean {
        @Headers("Content-Type: text/html")
        @POST("Logowanie2.aspx")
    ...
    private void invokeLoginRequest(String username, String pass) {
        ...
        String domain = "https://dziekanat.agh.edu.pl/";

        new Retrofit.Builder()
                .baseUrl(domain)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(VirtualDean.class)
                .login(getRequestBody(getStringBody(username, pass, true)))
...
//                        Log.i(TAG, "onResponse: " + call.request().toString());
    ...
    public VirtualDeanPresenter(View view, Context ctx) {
